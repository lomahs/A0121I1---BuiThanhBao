...
<html lang="en">
    <head>
        ...
        <%--              href="${pageContext.request.contextPath}/static/DataTables/datatables.min.css"/>--%>
        <%--        <link rel="stylesheet" type="text/css"--%>
        <%--              href="${pageContext.request.contextPath}/static/DataTables/DataTables-1.11.0/css/dataTables.bootstrap4.min.css"/>--%>
